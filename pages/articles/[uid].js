...
const Article = ({metaDescription, article, latestArticles, navigation, settings }) => {
  const date = prismicH.asDate(
    article.data.publishDate || article.first_publication_date
  );
  ...
  return (
    ...
    >
      <Head>
        ...
        <meta name="description" content={prismicH.asText(article.data.meta_description)}/>
...
export async function getStaticProps({ params, previewData }) {
  ...
  return {
    props: {
      metaDescription: article.data.meta_description,
      article,
      latestArticles,
      navigation,
      settings,
